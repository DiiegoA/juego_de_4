...
public class Usuario implements Serializable {
    ...
    @JoinColumn(name = "jugador", referencedColumnName = "identificacion")
    ...
    public Usuario(String correo, String contrasena, String color) {
        this.correo = correo;
    ...
    public String toString() {
        return "com.juegode4.modelo.Usuario[ correo=" + correo + " ]";
    }
