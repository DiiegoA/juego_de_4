...
import com.juegode4.controlador.util.JsfUtil.PersistAction;
...
public class ClasificacionController implements Serializable {
    ...
    @EJB
    private com.juegode4.controlador.ClasificacionFacade ejbFacade;
    ...
    public Clasificacion getClasificacion(java.lang.String id) {
    ...
    public static class ClasificacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Clasificacion) {
                ...
                return getStringKey(o.getJugador());
            } else {
